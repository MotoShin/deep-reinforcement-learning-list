...
from a2c_lstm.network import ActorCriticNetwork
from a2c_lstm.memory import Memory
...
class MasterAgent:
    def __init__(self, action_num):
        self.network = ActorCriticNetwork(AGENTS_NUM, action_num).type(DTYPE).to(device=DEVICE)
    ...
    def learning(self, trajectories, count):
        ...
        self.network.train()
        values, action_probs = self.network.learning(states)
